   ...
   bool document::on_open_document(var varFile)
   {
      ...
      if(pview->m_prender->m_dibImage.load_from_file(varFile))
      {
...

         {
            ...
            get_typed_view < view >()->m_strLootFilter = "image:" + get_typed_view < view >()->m_strImage + "," + get_typed_view < view >()->m_strLootFilter;
      ...
      else if(get_typed_view < ::userex::pane_tab_view >() != NULL)
      {
         ...
         get_typed_view < ::userex::pane_tab_view >()->set_cur_tab_by_id(::lootfilter::PaneViewLootFilter);
