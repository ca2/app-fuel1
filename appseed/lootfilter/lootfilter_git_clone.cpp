...
static string file_url(const char *host, const char *path)
{
   if (path[0] == '/')
      path++;

   string str;
   str.Format("file://%s/%s", host, path);
   return str;
}
...
//   const char *path = "C:\\git\\libstrophe";
//
//   string str = file_url("", path);
//   ASSERT(0 == git_clone__should_clone_local(str, GIT_CLONE_LOCAL_AUTO));
//   ASSERT(1 == git_clone__should_clone_local(str, GIT_CLONE_LOCAL));
//   ASSERT(1 == git_clone__should_clone_local(str, GIT_CLONE_LOCAL_NO_LINKS));
//   ASSERT(0 == git_clone__should_clone_local(str, GIT_CLONE_NO_LOCAL));
//
//   str = file_url("localhost", path);
//   ASSERT(0 == git_clone__should_clone_local(str, GIT_CLONE_LOCAL_AUTO));
//   ASSERT(1 == git_clone__should_clone_local(str, GIT_CLONE_LOCAL));
//   ASSERT(1 == git_clone__should_clone_local(str, GIT_CLONE_LOCAL_NO_LINKS));
//   ASSERT(0 == git_clone__should_clone_local(str, GIT_CLONE_NO_LOCAL));
...
//   //cl_assert_equal_i(0, git_clone__should_clone_local(str, GIT_CLONE_LOCAL_AUTO));
//   //cl_assert_equal_i(0, git_clone__should_clone_local(str, GIT_CLONE_LOCAL));
//   //cl_assert_equal_i(0, git_clone__should_clone_local(str, GIT_CLONE_LOCAL_NO_LINKS));
//   //cl_assert_equal_i(0, git_clone__should_clone_local(str, GIT_CLONE_NO_LOCAL));
//
...
//   //cl_assert_equal_i(0, git_clone__should_clone_local(str, GIT_CLONE_LOCAL_AUTO));
//   //cl_assert_equal_i(1, git_clone__should_clone_local(str, GIT_CLONE_LOCAL));
//   //cl_assert_equal_i(1, git_clone__should_clone_local(str, GIT_CLONE_LOCAL_NO_LINKS));
//   //cl_assert_equal_i(0, git_clone__should_clone_local(str, GIT_CLONE_NO_LOCAL));
//
