...
namespace lootfilter
{
   ...
   class CLASS_DECL_APP_FUEL_LOOTFILTER view :
   ...
   public:
      ...
      virtual string get_lootfilter();

      virtual string get_processed_lootfilter();

      virtual void set_lootfilter(string strText);
